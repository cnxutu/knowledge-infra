...
for app_name in "${APP_NAMES[@]}"; do
  ...
  if [[ -z "$remote_url" ]] || [[ "$remote_url" == manual://* ]]; then
    log "ℹ️ $app_name is configured for manual JAR management. Skip remote sync."
